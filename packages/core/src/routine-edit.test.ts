...
describe('validateRoutineRule', () => {
  it.each<Partial<Routine>>([
    ...
    { freq: 'daily', byWeekday: [], byMonthday: null },
    { freq: 'daily', byWeekday: null, byMonthday: [] },
    { freq: 'daily', byWeekday: [], byMonthday: [] },
    { byMonthday: [] },
    { freq: 'monthly', byWeekday: null, byMonthday: [1, 31] },
    { freq: 'monthly', byWeekday: [], byMonthday: [1, 31] },
    { repeatEvery: 365 },
    { endDate: '2026-03-01' },
  ])('유효한 규칙 %j', (patch) => {
  ...
  it.each<[Partial<Routine>, string]>([
    [{ freq: 'daily', byWeekday: [1] }, 'weekday_not_allowed'],
    [{ freq: 'daily', byWeekday: null, byMonthday: [1] }, 'monthday_not_allowed'],
    [{ byMonthday: [1] }, 'monthday_not_allowed'],
    [{ freq: 'monthly', byWeekday: [1], byMonthday: [1] }, 'weekday_not_allowed'],
    ...
    [{ freq: 'monthly', byWeekday: null, byMonthday: null }, 'monthday_required'],
    [{ freq: 'monthly', byWeekday: null, byMonthday: [] }, 'monthday_required'],
    [{ freq: 'monthly', byWeekday: null, byMonthday: [0] }, 'monthday_invalid'],
    [{ freq: 'monthly', byWeekday: null, byMonthday: [32] }, 'monthday_invalid'],
    [{ freq: 'monthly', byWeekday: null, byMonthday: [1.5] }, 'monthday_invalid'],
